    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    InformationRelationId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                schema: "urfit",
                table: "TimeSlots",
                columns: new[] { "Id", "DayOfWeek", "StartTime" },
                values: new object[,]
                {
                    { 1, 1, new TimeOnly(20, 0, 0) },
                    { 2, 3, new TimeOnly(8, 45, 0) },
                    { 3, 3, new TimeOnly(20, 0, 0) },
                    { 4, 6, new TimeOnly(9, 0, 0) }
                });
